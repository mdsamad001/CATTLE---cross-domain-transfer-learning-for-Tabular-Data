...
class TrainCollator:
    '''A base class for all collate function used for cattle training.
    '''
    def __init__(self,
        ...
        **kwargs,
        ...
        self.feature_extractor=cattleFeatureExtractor(
...
class cattleCollatorForCL(TrainCollator):
    '''support positive pair sampling for contrastive learning of cattle model.
    '''
    def __init__(self, 
        categorical_columns=None,
        numerical_columns=None,
