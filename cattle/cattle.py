...
from .modeling_cattle import cattleClassifier, cattleFeatureExtractor, cattleFeatureProcessor
from .modeling_cattle import cattleInputEncoder, cattleModel, MaskedClassifier
from .dataset import load_data, xgb, logistic_regression
from .evaluator import predict, evaluate
from .trainer import Trainer
from .trainer_utils import cattleCollatorForCL
...
def build_classifier(
    ...
    p=None,
    checkpoint=None,
    **kwargs) -> cattleClassifier:
    '''Build a :class:`cattle.modeling_cattle.cattleClassifier`.
    ...
    checkpoint: str
        the directory to load the pretrained cattle model.
...
def build_extractor(
    ...
    checkpoint=None,
    **kwargs,) -> cattleFeatureExtractor:
    '''Build a feature extractor for cattle model.
    ...
    checkpoint: str
        the directory of the predefined cattleFeatureExtractor.

    Returns
    -------
    A cattleFeatureExtractor module.
...
def build_encoder(
    ...
    **kwargs,
    ...
    if num_layer == 0:
        ...
        enc = cattleInputEncoder(feature_extractor, feature_processor)
        enc.load(checkpoint)
...
def build_contrastive_learner(
    ...
    **kwargs,
    ...
    '''Build a contrastive learner for pretraining based on cattle.
    ...
    checkpoint: str
        the directory of the pretrained cattle model.
    ...
    collate_fn = cattleCollatorForCL(
        categorical_columns=categorical_columns,
        numerical_columns=numerical_columns,
        binary_columns=binary_columns,
        overlap_ratio=overlap_ratio,
...
def train(model, 
    ...
    **kwargs,
    ...
    '''
    The shared train function for all cattleModel based models.

    Parameters
    ----------
    model: cattleModel and its subclass
